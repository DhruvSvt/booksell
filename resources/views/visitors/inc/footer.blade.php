        ...
        <div class="widget-wrap row">
            <div class="col-md-4 xs-padding">
                <div class="widget-content">
                    <img src="{{ config('app.url') }}/img/books&beyond logo.png" alt="logo">
            ...
            <div class="col-md-4 xs-padding">
                <div class="widget-content">
                    ...
                    <ul class="widget-link">
                        ...
                        <li><a href="{{ route('events') }}">EVENTS</span></a></li>
            ...
            <div class="col-md-4 xs-padding">
                <div class="widget-content">
                    <h3>Books & Beyond</h3>
                    <ul class="address">
                        <li><a style="color: white" href="mailto:adhit.mandal29@gmail.com"><i
                                    class="ti-email"></i>adhit.mandal29@gmail.com</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 sm-padding">
                <div class="copyright">Copyright &copy; Books & Beyond 2024 Designed by <a style="color: white"
                        href="https://svtindia.in/" target="_blank">SVT India</a></div>
            </div>
            {{-- <div class="col-md-6 sm-padding">
